...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_ergodox_pretty(
    ...
    LT(1,KC_GRAVE), KC_UP,          KC_DOWN,        LT(2,KC_LEFT),        SH_T(KC_RIGHT),                                                                                                       LT(1,KC_UP),    KC_DOWN,        KC_LEFT,        KC_RIGHT,       LCTL(LALT(LGUI(LSFT(KC_N)))),
  ...
  [1] = LAYOUT_ergodox_pretty(
    ...
    LT(2,KC_NO),    LCTL(LALT(LGUI(LSFT(KC_T)))),           KC_2,           KC_3,           KC_4,           KC_5,           KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_UP,          KC_7,           KC_8,           KC_9,           KC_KP_PLUS,     KC_F12,
    ...
    KC_TRANSPARENT, LSFT(LGUI(KC_A)),  KC_MS_WH_UP,    KC_MS_WH_DOWN,  LCTL(LSFT(KC_S)),                                                                                                 KC_TRANSPARENT, KC_KP_0,        RALT_T(KC_KP_DOT),KC_MPRV,      KC_MNXT,
